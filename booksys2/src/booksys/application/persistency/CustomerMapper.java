...
public class CustomerMapper
{
  ...
  private PersistentCustomer getFromCacheByDetails(String name, int phone)
  {
    ...
    while (c == null && enums.hasMoreElements()) {
      ...
      if (name.equals(tmp.getName()) && phone==(tmp.getPhoneNumber())) {
	c = tmp ;
      }
    }
    return c ;
  ...
  public PersistentCustomer getCustomer(String n, int p)
  {
  ...
  PersistentCustomer createCustomer(String name, int phone)
  {
